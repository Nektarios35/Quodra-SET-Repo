                                ...
                                <nav>
                                    <ul id="navigation">                                                                                                                                     
                                        <li><a href="../index.php">Home</a></li>
                                          <li><a href="cust_login.php">Customer Login</a></li>
                ...
                <div class="row m-0">
                    <div class="col-lg-4 offset-lg-4">
                        <div class="text-center pb-10">
                            <h1 class="login-title text-dark">Customer Login</h1>
                        </br>
                            <p class="p-1 m-0 font-ubuntu text-black-50">Swift Bookings</p>
                        </br>
                            <span>Don't Have An Account? <a href="../user_register/user_reg.php">Sign Up</a></span>
                    </div>
                </br>
              </br>
